...
func TestJsonRpcClient(t *testing.T) {
	...
	// }
	resp, err := client.Syncing(context.Background())
	fmt.Println("RESP ERR: ", resp, err)

	// resp, err := client.BlockByHash(context.Background(), "0x14b05305c69bcfa91945cd2a1a0cd4d9e8879b96e57a1688843a0719afce7c2", "FULL_TXNS")
	// if err != nil {
	// 	t.Errorf("Could not retrieve block: %v\n", err)
	// }
