...
// Source: ./rpc/provider.go
//
// Generated by this command:
//
//	mockgen -destination=./internal/tests/mocks/rpcv10mock/rpc.go -package=rpcv10mock -source=./rpc/provider.go
//
...
func (m *MockRPCProvider) BlockWithTxHashes(ctx context.Context, blockID rpc.BlockID) (rpc.BlockWithTxHashesResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BlockWithTxHashes", ctx, blockID)
	ret0, _ := ret[0].(rpc.BlockWithTxHashesResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockRPCProvider) BlockWithTxs(ctx context.Context, blockID rpc.BlockID) (rpc.BlockWithTxsResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BlockWithTxs", ctx, blockID)
	ret0, _ := ret[0].(rpc.BlockWithTxsResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
