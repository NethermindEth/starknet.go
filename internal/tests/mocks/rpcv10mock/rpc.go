...
func (m *MockRPCProvider) AddDeclareTransaction(ctx context.Context, declareTransaction *rpcv10.BroadcastDeclareTxnV3) (rpcv10.AddDeclareTransactionResponse, error) {
	m.ctrl.T.Helper()
...
func (m *MockRPCProvider) AddDeployAccountTransaction(ctx context.Context, deployAccountTransaction *rpcv10.BroadcastDeployAccountTxnV3) (rpcv10.AddDeployAccountTransactionResponse, error) {
	m.ctrl.T.Helper()
...
func (m *MockRPCProvider) AddInvokeTransaction(ctx context.Context, invokeTxn *rpcv10.BroadcastInvokeTxnV3) (rpcv10.AddInvokeTransactionResponse, error) {
	m.ctrl.T.Helper()
