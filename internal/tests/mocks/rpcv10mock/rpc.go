...
func (m *MockRPCProvider) AddDeclareTransaction(ctx context.Context, declareTransaction *types.BroadcastDeclareTxnV3) (rpcv10.AddDeclareTransactionResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AddDeclareTransaction", ctx, declareTransaction)
	ret0, _ := ret[0].(rpcv10.AddDeclareTransactionResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockRPCProvider) AddDeployAccountTransaction(ctx context.Context, deployAccountTransaction *types.BroadcastDeployAccountTxnV3) (rpcv10.AddDeployAccountTransactionResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AddDeployAccountTransaction", ctx, deployAccountTransaction)
	ret0, _ := ret[0].(rpcv10.AddDeployAccountTransactionResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockRPCProvider) AddInvokeTransaction(ctx context.Context, invokeTxn *types.BroadcastInvokeTxnV3) (rpcv10.AddInvokeTransactionResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AddInvokeTransaction", ctx, invokeTxn)
	ret0, _ := ret[0].(rpcv10.AddInvokeTransactionResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockRPCProvider) BlockHashAndNumber(ctx context.Context) (*rpcv10.BlockHashAndNumberOutput, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BlockHashAndNumber", ctx)
	ret0, _ := ret[0].(*rpcv10.BlockHashAndNumberOutput)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockRPCProvider) Call(ctx context.Context, call types.FunctionCall, block rpcv10.BlockID) ([]*felt.Felt, error) {
	m.ctrl.T.Helper()
...
func (m *MockRPCProvider) EstimateFee(ctx context.Context, requests []types.BroadcastTxn, simulationFlags []rpcv10.SimulationFlag, blockID rpcv10.BlockID) ([]types.FeeEstimation, error) {
	m.ctrl.T.Helper()
...
func (m *MockRPCProvider) EstimateMessageFee(ctx context.Context, msg rpcv10.MsgFromL1, blockID rpcv10.BlockID) (types.MessageFeeEstimation, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "EstimateMessageFee", ctx, msg, blockID)
	ret0, _ := ret[0].(types.MessageFeeEstimation)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockRPCProvider) Events(ctx context.Context, input rpcv10.EventsInput) (*rpcv10.EventChunk, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Events", ctx, input)
	ret0, _ := ret[0].(*rpcv10.EventChunk)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockRPCProvider) SimulateTransactions(ctx context.Context, blockID rpcv10.BlockID, txns []types.BroadcastTxn, simulationFlags []rpcv10.SimulationFlag) ([]rpcv10.SimulatedTransaction, error) {
	m.ctrl.T.Helper()
...
func (m *MockRPCProvider) StorageProof(ctx context.Context, storageProofInput rpcv10.StorageProofInput) (*rpcv10.StorageProofResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "StorageProof", ctx, storageProofInput)
	ret0, _ := ret[0].(*rpcv10.StorageProofResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockRPCProvider) Syncing(ctx context.Context) (rpcv10.SyncStatus, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Syncing", ctx)
	ret0, _ := ret[0].(rpcv10.SyncStatus)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockRPCProvider) TraceTransaction(ctx context.Context, transactionHash *felt.Felt) (rpcv10.TxnTrace, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TraceTransaction", ctx, transactionHash)
	ret0, _ := ret[0].(rpcv10.TxnTrace)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockWebsocketProvider) SubscribeEvents(ctx context.Context, events chan<- *rpcv10.EmittedEventWithFinalityStatus, options *rpcv10.EventSubscriptionInput) (*client.ClientSubscription, error) {
	m.ctrl.T.Helper()
...
func (m *MockWebsocketProvider) SubscribeNewTransactions(ctx context.Context, newTxns chan<- *rpcv10.TxnWithHashAndStatus, options *rpcv10.SubNewTxnsInput) (*client.ClientSubscription, error) {
	m.ctrl.T.Helper()
...
func (m *MockWebsocketProvider) SubscribeTransactionStatus(ctx context.Context, newStatus chan<- *rpcv10.NewTxnStatus, transactionHash *felt.Felt) (*client.ClientSubscription, error) {
	m.ctrl.T.Helper()
