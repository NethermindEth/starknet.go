	...
	t.Run("mock", func(t *testing.T) {
		...
		t.Run("deploy transaction type - sponsored fee mode", func(t *testing.T) {
			...
			expectedReqs := internalUtils.TestUnmarshalJSONFileToType[[]json.RawMessage](
				t,
				"testdata/build_txn/deploy-request.json",
				"params",
			)
			...
			expectedResp := internalUtils.TestUnmarshalJSONFileToType[json.RawMessage](
				t,
				"testdata/build_txn/deploy-response.json",
				"result",
			)
		...
		t.Run("invoke transaction type - default fee mode with custom tip", func(t *testing.T) {
			...
			expectedReqs := internalUtils.TestUnmarshalJSONFileToType[[]json.RawMessage](
				t,
				"testdata/build_txn/invoke-request.json",
				"params",
			)
			expectedReq := expectedReqs[0]
			...
			expectedResp := internalUtils.TestUnmarshalJSONFileToType[json.RawMessage](
				t,
				"testdata/build_txn/invoke-response.json",
				"result",
			)
		...
		t.Run(
			...
			func(t *testing.T) {
				...
				expectedReqs := internalUtils.TestUnmarshalJSONFileToType[[]json.RawMessage](
					t,
					"testdata/build_txn/deploy_and_invoke-request.json",
					"params",
				)
				expectedReq := expectedReqs[0]
				...
				expectedResp := internalUtils.TestUnmarshalJSONFileToType[json.RawMessage](
					t,
					"testdata/build_txn/deploy_and_invoke-response.json",
					"result",
				)
