...
type RPCProvider interface {
	...
	BlockWithTxHashes(ctx context.Context, blockID BlockID) (BlockWithTxHashesResult, error)
	BlockWithTxs(ctx context.Context, blockID BlockID) (BlockWithTxsResult, error)
