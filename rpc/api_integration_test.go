...
// func TestIntegrationNodeGetClassAt(t *testing.T) {
// 	godotenv.Load()
// 	if os.Getenv("INTEGRATION") != "true" {
// 		t.Skip("Skipping integration test")
// 	}
...
// 		t.Fatal(err)
// 	}
// 	err = node.GetClassAt(context.Background(), "0x6fbd460228d843b7fbef670ff15607bf72e19fa94de21e29811ada167b4ca39")
// 	if err != nil {
// 		t.Fatal(err)
// 	}
// }
