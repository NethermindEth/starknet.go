...
func (provider *Provider) Syncing(ctx context.Context) (*types.SyncResponse, error) {
...
func (provider *Provider) StateUpdate(ctx context.Context, blockID types.BlockID) (*types.StateUpdateOutput, error) {
