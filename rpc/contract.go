...
func (provider *Provider) ClassAt(ctx context.Context, blockID types.BlockID, contractAddress types.Hash) (*types.ContractClass, error) {
	var rawClass types.ContractClass
...
func (provider *Provider) ClassHashAt(ctx context.Context, blockID types.BlockID, contractAddress types.Hash) (*string, error) {
	var result string
...
func (provider *Provider) StorageAt(ctx context.Context, contractAddress types.Hash, key string, blockID types.BlockID) (string, error) {
	var value string
