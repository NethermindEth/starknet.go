...
import (
	...
	types "github.com/NethermindEth/starknet.go/types"
...
func (m *MockRPCProvider) EstimateFee(ctx context.Context, requests []types.BroadcastTxn, simulationFlags []rpcv10.SimulationFlag, blockID rpcv10.BlockID) ([]rpcv10.FeeEstimation, error) {
	m.ctrl.T.Helper()
