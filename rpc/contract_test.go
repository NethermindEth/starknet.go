...
func TestClassAt(t *testing.T) {
	...
	testSet := map[string][]testSetType{
		...
		"testnet": {
			{
				ContractAddress:   ctypes.HexToHash("0x6fbd460228d843b7fbef670ff15607bf72e19fa94de21e29811ada167b4ca39"),
				ExpectedOperation: "0x480680017fff8000",
			},
		},
		"mainnet": {
			{
				ContractAddress:   ctypes.HexToHash("0x028105caf03e1c4eb96b1c18d39d9f03bd53e5d2affd0874792e5bf05f3e529f"),
...
func TestClassHashAt(t *testing.T) {
	...
	type testSetType struct {
		ContractHash      ctypes.Hash
		ExpectedClassHash string
	}
	testSet := map[string][]testSetType{
		"mock": {
			{
				ContractHash:      ctypes.HexToHash("0xdeadbeef"),
				ExpectedClassHash: "0xdeadbeef",
			},
		},
		"testnet": {
			{
				ContractHash:      ctypes.HexToHash("0x315e364b162653e5c7b23efd34f8da27ba9c069b68e3042b7d76ce1df890313"),
				ExpectedClassHash: "0x493af3546940eb96471cf95ae3a5aa1286217b07edd1e12d00143010ca904b1",
			},
		},
		"mainnet": {
			{
				ContractHash:      ctypes.HexToHash("0x3b4be7def2fc08589348966255e101824928659ebb724855223ff3a8c831efa"),
...
func TestStorageAt(t *testing.T) {
	...
	testSet := map[string][]testSetType{
		...
		"testnet": {
			{
				ContractHash:  ctypes.HexToHash("0x6fbd460228d843b7fbef670ff15607bf72e19fa94de21e29811ada167b4ca39"),
				StorageKey:    "balance",
				Block:         WithBlockTag("latest"),
		...
		"mainnet": {
			{
				ContractHash:  ctypes.HexToHash("0x8d17e6a3B92a2b5Fa21B8e7B5a3A794B05e06C5FD6C6451C6F2695Ba77101"),
				StorageKey:    "_signer",
				Block:         WithBlockTag("latest"),
...
func TestNonce(t *testing.T) {
	...
	testSet := map[string][]testSetType{
		"mock": {
			{
				ContractAddress: ctypes.HexToHash("0x0207acc15dc241e7d167e67e30e769719a727d3e0fa47f9e187707289885dfde"),
			},
		},
		"testnet": {
			{
