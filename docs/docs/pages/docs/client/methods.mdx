...
**Source:** [client.go:L340](https://github.com/NethermindEth/starknet.go/blob/main/client/client.go#L340)
...
**Source:** [client.go:L359](https://github.com/NethermindEth/starknet.go/blob/main/client/client.go#L359)
...
- `result` - Pointer to variable where the result will be unmarshaled
- `method` - The JSON-RPC method name to call
- `args` - Arguments to pass to the method (single interface{} that can be a struct or other type)
...
**Source:** [client.go:L408](https://github.com/NethermindEth/starknet.go/blob/main/client/client.go#L408)
...
**Source:** [client.go:L541](https://github.com/NethermindEth/starknet.go/blob/main/client/client.go#L541)
...
- `args` - Arguments for the subscription (single interface{} that can be a struct or other type)
...
**Source:** [client.go:L311](https://github.com/NethermindEth/starknet.go/blob/main/client/client.go#L311)
...
**Source:** [subscription.go:L280](https://github.com/NethermindEth/starknet.go/blob/main/client/subscription.go#L280)
...
**Source:** [subscription.go:L268](https://github.com/NethermindEth/starknet.go/blob/main/client/subscription.go#L268)
