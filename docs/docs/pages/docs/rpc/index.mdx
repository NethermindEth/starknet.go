...
- **[TransactionByBlockIdAndIndex](/docs/rpc/methods/transaction-by-block-id-and-index)** - Get transaction by position
...
- **[Class](/docs/rpc/methods/class)** - Get contract class definition
- **[ClassAt](/docs/rpc/methods/class-at)** - Get class at address
- **[ClassHashAt](/docs/rpc/methods/class-hash-at)** - Get class hash for address
- **[StorageAt](/docs/rpc/methods/storage-at)** - Read contract storage
- **[Nonce](/docs/rpc/methods/nonce)** - Get account nonce
...
- **[GetStorageProof](/docs/rpc/methods/get-storage-proof)** - Get storage Merkle proof
...
See the [Read Events example](/docs/examples/read-events) for filtering patterns.
...
- **[SimulateTransactions](/docs/rpc/methods/simulate-transactions)** - Simulate before sending
