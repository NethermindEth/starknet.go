...
- [TraceTransaction](/docs/rpc/methods/trace-transaction) - Trace a single transaction
- [SimulateTransactions](/docs/rpc/methods/simulate-transaction) - Simulate transactions before sending
- [BlockWithTxs](/docs/rpc/methods/block-with-txs) - Get block with full transaction details
- [StateUpdate](/docs/rpc/methods/state-update) - Get state changes for a block