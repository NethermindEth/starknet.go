...
- [SimulateTransactions](/docs/rpc/methods/simulate-transaction) - Simulate transactions before sending them
- [TraceBlockTransactions](/docs/rpc/methods/trace-block-transactions) - Trace all transactions in a block
- [TransactionReceipt](/docs/rpc/methods/transaction-receipt) - Get transaction execution results