...
- [SimulateTransactions](/docs/rpc/methods/simulate-transaction) - Test transactions before submitting
- [EstimateFee](/docs/rpc/methods/estimate-fee) - Estimate transaction fees
- [TransactionReceipt](/docs/rpc/methods/transaction-receipt) - Check transaction execution status
- [Nonce](/docs/rpc/methods/get-nonce) - Get current nonce for transaction sequencing