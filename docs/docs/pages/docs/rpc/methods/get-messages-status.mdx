...
- [TransactionByHash](./transaction-by-hash.md) - Get L2 transaction details
- [TransactionReceipt](./transaction-receipt.md) - Get L2 transaction execution results
- [BlockWithTxs](./block-with-txs.md) - Get block containing L1 handler transactions
...
*This method is essential for tracking cross-chain messaging and ensuring reliable L1↔L2 communication in your dApps.*