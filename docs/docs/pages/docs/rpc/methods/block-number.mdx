...
- Polling the network at regular intervals to track new blocks. See [example](/docs/rpc/examples#monitor-network-height).
- Waiting until the network reaches a specific block height before proceeding. See [example](/docs/rpc/examples#wait-for-specific-block-height).
