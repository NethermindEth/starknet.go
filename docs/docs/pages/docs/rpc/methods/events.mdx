...
- [BlockWithTxs](/docs/rpc/methods/block-with-txs) - Get blocks containing the transactions that emitted events
- [TransactionReceipt](/docs/rpc/methods/transaction-receipt) - Get detailed transaction information including all emitted events
- [SubscribeEvents](/docs/rpc/websocket/subscribe-events) - Subscribe to real-time event notifications via WebSocket
