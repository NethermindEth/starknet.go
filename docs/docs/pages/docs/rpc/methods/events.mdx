...
- [TransactionReceipt](/docs/rpc/methods/transaction-receipt) - Get detailed information about transactions including their events
- [TransactionByHash](/docs/rpc/methods/transaction-by-hash) - Get transaction details for event sources