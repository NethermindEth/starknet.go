...
**Source:** [transactions.go:L46-L55](https://github.com/NethermindEth/starknet.go/blob/main/utils/transactions.go#L46-L55)
...
**Source:** [transactions.go:L59-L65](https://github.com/NethermindEth/starknet.go/blob/main/utils/transactions.go#L59-L65)
...
**Source:** [transactions.go:L69-L79](https://github.com/NethermindEth/starknet.go/blob/main/utils/transactions.go#L69-L79)
...
**Source:** [udc.go:L55-L64](https://github.com/NethermindEth/starknet.go/blob/main/utils/udc.go#L55-L64)
...
**Source:** [keccak.go:L14-L17](https://github.com/NethermindEth/starknet.go/blob/main/utils/keccak.go#L14-L17)
...
- [Examples](/docs/utils/examples) - Comprehensive examples using all utils types
- [Overview](/docs/utils/) - Complete utils package overview
