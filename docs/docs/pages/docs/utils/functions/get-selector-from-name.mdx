...
- [GetSelectorFromNameFelt](/docs/utils/functions/get-selector-from-name-felt) - Returns selector as `*felt.Felt`
- [Keccak256](/docs/utils/functions/keccak256) - Low-level Keccak hash function
- [BigToHex](/docs/utils/functions/big-to-hex) - Convert `*big.Int` to hex string
