  ...
  "/docs/": [
          ...
          items: [
            {
              ...
              link: "/docs/account/concepts/transaction-signing",
            },
          ],
        },
        {
          ...
          items: [
            {
              text: "FmtCallDataCairo0",
              link: "/docs/account/functions/fmt-calldata-cairo0",
            },
            {
              text: "FmtCallDataCairo2",
              link: "/docs/account/functions/fmt-calldata-cairo2",
            },
            {
              text: "PrecomputeAccountAddress",
              link: "/docs/account/functions/precompute-account-address",
            },
          ],
        },
        {
          ...
          items: [
            ...
            {
              text: "BuildAndEstimateDeployAccountTxn",
              link: "/docs/account/methods/build-and-estimate-deploy-account-txn",
            },
            {
              text: "BuildAndSendDeclareTxn",
              link: "/docs/account/methods/build-and-send-declare-txn",
            },
            {
              text: "BuildAndSendInvokeTxn",
              link: "/docs/account/methods/build-and-send-invoke-txn",
            },
            {
              text: "DeployContractWithUDC",
              link: "/docs/account/methods/deploy-contract-with-udc",
            },
            { text: "FmtCalldata", link: "/docs/account/methods/fmt-calldata" },
            { text: "Nonce", link: "/docs/account/methods/nonce" },
            {
              text: "SendTransaction",
              link: "/docs/account/methods/send-transaction",
            },
            { text: "Sign", link: "/docs/account/methods/sign" },
            {
              text: "SignDeclareTransaction",
              link: "/docs/account/methods/sign-declare-transaction",
            },
            {
              text: "SignDeployAccountTransaction",
              link: "/docs/account/methods/sign-deploy-account-transaction",
            },
            {
              text: "SignInvokeTransaction",
              link: "/docs/account/methods/sign-invoke-transaction",
            },
            {
              text: "TransactionHashDeclare",
              link: "/docs/account/methods/transaction-hash-declare",
            },
            {
              text: "TransactionHashDeployAccount",
              link: "/docs/account/methods/transaction-hash-deploy-account",
            },
            {
              text: "TransactionHashInvoke",
              link: "/docs/account/methods/transaction-hash-invoke",
            },
            { text: "Verify", link: "/docs/account/methods/verify" },
            {
              text: "WaitForTransactionReceipt",
              link: "/docs/account/methods/wait-for-transaction-receipt",
            },
          ],
        },
        {
          ...
          items: [
            {
              text: "GetRandomKeys",
              link: "/docs/account/keystore/get-random-keys",
            },
            {
              text: "NewMemKeystore",
              link: "/docs/account/keystore/new-mem-keystore",
            },
            {
              text: "SetNewMemKeystore",
              link: "/docs/account/keystore/set-new-mem-keystore",
            },
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            { text: "Class", link: "/docs/rpc/methods/class" },
            { text: "ClassAt", link: "/docs/rpc/methods/class-at" },
            {
              text: "ClassHashAt",
              link: "/docs/rpc/methods/class-hash-at",
            },
            { text: "Nonce", link: "/docs/rpc/methods/nonce" },
            { text: "StorageAt", link: "/docs/rpc/methods/storage-at" },
    ...
    },
    {
      ...
      items: [
        { text: "Overview", link: "/docs/contracts/" },
        {
          ...
          items: [
            {
              text: "PrecomputeAddress",
              link: "/docs/contracts/functions/precompute-address",
            },
            {
              text: "UnmarshalCasmClass",
              link: "/docs/contracts/functions/unmarshal-casm-class",
            },
          ],
        },
      ...
      items: [
...

        {
          ...
          items: [
            ...
            {
              text: "HexArrToFelt",
              link: "/docs/utils/functions/hex-arr-to-felt",
            },
            { text: "HexToBytes", link: "/docs/utils/functions/hex-to-bytes" },
            {
              text: "FeltToBigInt",
              link: "/docs/utils/functions/felt-to-big-int",
            },
            {
              text: "FeltArrToBigIntArr",
              link: "/docs/utils/functions/felt-arr-to-big-int-arr",
            },
            {
              text: "BigIntToFelt",
              link: "/docs/utils/functions/big-int-to-felt",
            },
            ...
            {
              text: "Uint64ToFelt",
              link: "/docs/utils/functions/uint64-to-felt",
            },
          ],
        },
        {
        ...
        },
        {
          ...
          items: [
            {
              text: "BuildInvokeTxn",
              link: "/docs/utils/functions/build-invoke-txn",
            },
            {
              text: "BuildDeclareTxn",
              link: "/docs/utils/functions/build-declare-txn",
            },
            {
              text: "BuildDeployAccountTxn",
              link: "/docs/utils/functions/build-deploy-account-txn",
            },
          ],
        },
        {
          ...
          items: [
            {
              text: "HexToShortStr",
              link: "/docs/utils/functions/hex-to-short-str",
            },
        ...
        },
        {
          ...
          items: [
            {
              text: "GetSelectorFromName",
              link: "/docs/utils/functions/get-selector-from-name",
            },
            {
              text: "GetSelectorFromNameFelt",
              link: "/docs/utils/functions/get-selector-from-name-felt",
            },
            { text: "Keccak256", link: "/docs/utils/functions/keccak256" },
          ],
        },
        { text: "Examples", link: "/docs/utils/examples" },
      ],
    },
    {
      text: "typeddata",
    ...
    },
    {
      ...
      items: [
        { text: "Overview", link: "/docs/hash/" },
        {
          ...
          items: [
            {
              text: "Transaction Hashing",
              link: "/docs/hash/concepts/transaction-hashing",
            },
          ],
        },
        {
          ...
          items: [
            ...
            {
              text: "CompiledClassHash",
              link: "/docs/hash/functions/compiled-class-hash",
            },
            {
              text: "TransactionHashInvokeV0",
              link: "/docs/hash/functions/transaction-hash-invoke-v0",
            },
            {
              text: "TransactionHashInvokeV1",
              link: "/docs/hash/functions/transaction-hash-invoke-v1",
            },
            {
              text: "TransactionHashInvokeV3",
              link: "/docs/hash/functions/transaction-hash-invoke-v3",
            },
            {
              text: "TransactionHashDeclareV1",
              link: "/docs/hash/functions/transaction-hash-declare-v1",
            },
            {
              text: "TransactionHashDeclareV2",
              link: "/docs/hash/functions/transaction-hash-declare-v2",
            },
            {
              text: "TransactionHashDeclareV3",
              link: "/docs/hash/functions/transaction-hash-declare-v3",
            },
            {
              text: "TransactionHashBroadcastDeclareV3",
              link: "/docs/hash/functions/transaction-hash-broadcast-declare-v3",
            },
            {
              text: "TransactionHashDeployAccountV1",
              link: "/docs/hash/functions/transaction-hash-deploy-account-v1",
            },
            {
              text: "TransactionHashDeployAccountV3",
              link: "/docs/hash/functions/transaction-hash-deploy-account-v3",
            },
            {
              text: "CalculateDeprecatedTransactionHashCommon",
              link: "/docs/hash/functions/calculate-deprecated-transaction-hash-common",
            },
            {
              text: "TipAndResourcesHash",
              link: "/docs/hash/functions/tip-and-resources-hash",
            },
            {
              text: "DataAvailabilityModeConc",
              link: "/docs/hash/functions/data-availability-mode-conc",
            },
          ],
        },
      ...
      items: [
        { text: "Overview", link: "/docs/curve/" },
        {
          ...
          items: [
            ...
            {
              text: "PedersenArray",
              link: "/docs/curve/functions/pedersen-array",
            },
            { text: "Poseidon", link: "/docs/curve/functions/poseidon" },
            {
              text: "PoseidonArray",
              link: "/docs/curve/functions/poseidon-array",
            },
            {
              text: "StarknetKeccak",
              link: "/docs/curve/functions/starknet-keccak",
            },
            {
              text: "ComputeHashOnElements",
              link: "/docs/curve/functions/compute-hash-on-elements",
            },
            {
              text: "HashPedersenElements",
              link: "/docs/curve/functions/hash-pedersen-elements",
            },
            {
              text: "GetRandomKeys",
              link: "/docs/curve/functions/get-random-keys",
            },
            {
              text: "PrivateKeyToPoint",
              link: "/docs/curve/functions/private-key-to-point",
            },
            {
              text: "GetYCoordinate",
              link: "/docs/curve/functions/get-y-coordinate",
            },
      ...
      items: [
        { text: "Overview", link: "/docs/merkle/" },
        {
          ...
          items: [
            ...
            {
              text: "ProofMerklePath",
              link: "/docs/merkle/functions/proof-merkle-path",
            },
            {
              text: "NewFixedSizeMerkleTree",
              link: "/docs/merkle/functions/new-fixed-size-merkle-tree",
            },
          ],
        },
        {
          text: "Methods",
          collapsed: true,
          items: [{ text: "Proof", link: "/docs/merkle/methods/proof" }],
        },
      ...
      items: [
        { text: "Overview", link: "/docs/paymaster/" },
        {
          ...
          items: [
            ...
            {
              text: "IsAvailable",
              link: "/docs/paymaster/methods/is-available",
            },
            {
              text: "GetSupportedTokens",
              link: "/docs/paymaster/methods/get-supported-tokens",
            },
            {
              text: "BuildTransaction",
              link: "/docs/paymaster/methods/build-transaction",
            },
            {
              text: "ExecuteTransaction",
              link: "/docs/paymaster/methods/execute-transaction",
            },
            {
              text: "TrackingIDToLatestHash",
              link: "/docs/paymaster/methods/tracking-id-to-latest-hash",
            },
          ],
        },
      ],
    ...
    },
    {
      ...
      items: [
        ...
        {
          text: "Deploy Contract UDC",
          link: "/docs/examples/deploy-contract-udc",
        },
