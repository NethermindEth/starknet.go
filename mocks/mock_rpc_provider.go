...
func (m *MockRPCProvider) EstimateTip(ctx context.Context) (rpc.U64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "EstimateTip", ctx)
	ret0, _ := ret[0].(rpc.U64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// EstimateTip indicates an expected call of EstimateTip.
func (mr *MockRPCProviderMockRecorder) EstimateTip(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "EstimateTip", reflect.TypeOf((*MockRPCProvider)(nil).EstimateTip), ctx)
}
...
func (m *MockRPCProvider) IsCompatible(ctx context.Context) (bool, string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "IsCompatible", ctx)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(string)
	ret2, _ := ret[2].(error)
...
func (mr *MockRPCProviderMockRecorder) IsCompatible(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IsCompatible", reflect.TypeOf((*MockRPCProvider)(nil).IsCompatible), ctx)
}
...
// MockStarknetSpec is a mock of StarknetSpec interface.
type MockStarknetSpec struct {
	ctrl     *gomock.Controller
	recorder *MockStarknetSpecMockRecorder
	isgomock struct{}
}

// MockStarknetSpecMockRecorder is the mock recorder for MockStarknetSpec.
type MockStarknetSpecMockRecorder struct {
	mock *MockStarknetSpec
}

// NewMockStarknetSpec creates a new mock instance.
func NewMockStarknetSpec(ctrl *gomock.Controller) *MockStarknetSpec {
	mock := &MockStarknetSpec{ctrl: ctrl}
	mock.recorder = &MockStarknetSpecMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockStarknetSpec) EXPECT() *MockStarknetSpecMockRecorder {
	return m.recorder
}

// AddDeclareTransaction mocks base method.
func (m *MockStarknetSpec) AddDeclareTransaction(ctx context.Context, declareTransaction *rpc.BroadcastDeclareTxnV3) (rpc.AddDeclareTransactionResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AddDeclareTransaction", ctx, declareTransaction)
	ret0, _ := ret[0].(rpc.AddDeclareTransactionResponse)
	ret1, _ := ret[1].(error)
...
// AddDeclareTransaction indicates an expected call of AddDeclareTransaction.
func (mr *MockStarknetSpecMockRecorder) AddDeclareTransaction(ctx, declareTransaction any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddDeclareTransaction", reflect.TypeOf((*MockStarknetSpec)(nil).AddDeclareTransaction), ctx, declareTransaction)
}

// AddDeployAccountTransaction mocks base method.
func (m *MockStarknetSpec) AddDeployAccountTransaction(ctx context.Context, deployAccountTransaction *rpc.BroadcastDeployAccountTxnV3) (rpc.AddDeployAccountTransactionResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AddDeployAccountTransaction", ctx, deployAccountTransaction)
	ret0, _ := ret[0].(rpc.AddDeployAccountTransactionResponse)
	ret1, _ := ret[1].(error)
...
// AddDeployAccountTransaction indicates an expected call of AddDeployAccountTransaction.
func (mr *MockStarknetSpecMockRecorder) AddDeployAccountTransaction(ctx, deployAccountTransaction any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddDeployAccountTransaction", reflect.TypeOf((*MockStarknetSpec)(nil).AddDeployAccountTransaction), ctx, deployAccountTransaction)
}

// AddInvokeTransaction mocks base method.
func (m *MockStarknetSpec) AddInvokeTransaction(ctx context.Context, invokeTxn *rpc.BroadcastInvokeTxnV3) (rpc.AddInvokeTransactionResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AddInvokeTransaction", ctx, invokeTxn)
	ret0, _ := ret[0].(rpc.AddInvokeTransactionResponse)
	ret1, _ := ret[1].(error)
...
// AddInvokeTransaction indicates an expected call of AddInvokeTransaction.
func (mr *MockStarknetSpecMockRecorder) AddInvokeTransaction(ctx, invokeTxn any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddInvokeTransaction", reflect.TypeOf((*MockStarknetSpec)(nil).AddInvokeTransaction), ctx, invokeTxn)
}

// BlockHashAndNumber mocks base method.
func (m *MockStarknetSpec) BlockHashAndNumber(ctx context.Context) (*rpc.BlockHashAndNumberOutput, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BlockHashAndNumber", ctx)
	ret0, _ := ret[0].(*rpc.BlockHashAndNumberOutput)
	ret1, _ := ret[1].(error)
...
// BlockHashAndNumber indicates an expected call of BlockHashAndNumber.
func (mr *MockStarknetSpecMockRecorder) BlockHashAndNumber(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BlockHashAndNumber", reflect.TypeOf((*MockStarknetSpec)(nil).BlockHashAndNumber), ctx)
}

// BlockNumber mocks base method.
func (m *MockStarknetSpec) BlockNumber(ctx context.Context) (uint64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BlockNumber", ctx)
	ret0, _ := ret[0].(uint64)
	ret1, _ := ret[1].(error)
...
// BlockNumber indicates an expected call of BlockNumber.
func (mr *MockStarknetSpecMockRecorder) BlockNumber(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BlockNumber", reflect.TypeOf((*MockStarknetSpec)(nil).BlockNumber), ctx)
}

// BlockTransactionCount mocks base method.
func (m *MockStarknetSpec) BlockTransactionCount(ctx context.Context, blockID rpc.BlockID) (uint64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BlockTransactionCount", ctx, blockID)
	ret0, _ := ret[0].(uint64)
	ret1, _ := ret[1].(error)
...
// BlockTransactionCount indicates an expected call of BlockTransactionCount.
func (mr *MockStarknetSpecMockRecorder) BlockTransactionCount(ctx, blockID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BlockTransactionCount", reflect.TypeOf((*MockStarknetSpec)(nil).BlockTransactionCount), ctx, blockID)
}

// BlockWithReceipts mocks base method.
func (m *MockStarknetSpec) BlockWithReceipts(ctx context.Context, blockID rpc.BlockID) (any, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BlockWithReceipts", ctx, blockID)
	ret0, _ := ret[0].(any)
	ret1, _ := ret[1].(error)
...
// BlockWithReceipts indicates an expected call of BlockWithReceipts.
func (mr *MockStarknetSpecMockRecorder) BlockWithReceipts(ctx, blockID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BlockWithReceipts", reflect.TypeOf((*MockStarknetSpec)(nil).BlockWithReceipts), ctx, blockID)
}

// BlockWithTxHashes mocks base method.
func (m *MockStarknetSpec) BlockWithTxHashes(ctx context.Context, blockID rpc.BlockID) (any, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BlockWithTxHashes", ctx, blockID)
	ret0, _ := ret[0].(any)
	ret1, _ := ret[1].(error)
...
// BlockWithTxHashes indicates an expected call of BlockWithTxHashes.
func (mr *MockStarknetSpecMockRecorder) BlockWithTxHashes(ctx, blockID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BlockWithTxHashes", reflect.TypeOf((*MockStarknetSpec)(nil).BlockWithTxHashes), ctx, blockID)
}

// BlockWithTxs mocks base method.
func (m *MockStarknetSpec) BlockWithTxs(ctx context.Context, blockID rpc.BlockID) (any, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BlockWithTxs", ctx, blockID)
	ret0, _ := ret[0].(any)
	ret1, _ := ret[1].(error)
...
// BlockWithTxs indicates an expected call of BlockWithTxs.
func (mr *MockStarknetSpecMockRecorder) BlockWithTxs(ctx, blockID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BlockWithTxs", reflect.TypeOf((*MockStarknetSpec)(nil).BlockWithTxs), ctx, blockID)
}

// Call mocks base method.
func (m *MockStarknetSpec) Call(ctx context.Context, call rpc.FunctionCall, block rpc.BlockID) ([]*felt.Felt, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Call", ctx, call, block)
	ret0, _ := ret[0].([]*felt.Felt)
	ret1, _ := ret[1].(error)
...
// Call indicates an expected call of Call.
func (mr *MockStarknetSpecMockRecorder) Call(ctx, call, block any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Call", reflect.TypeOf((*MockStarknetSpec)(nil).Call), ctx, call, block)
}

// ChainID mocks base method.
func (m *MockStarknetSpec) ChainID(ctx context.Context) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ChainID", ctx)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
...
// ChainID indicates an expected call of ChainID.
func (mr *MockStarknetSpecMockRecorder) ChainID(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ChainID", reflect.TypeOf((*MockStarknetSpec)(nil).ChainID), ctx)
}

// Class mocks base method.
func (m *MockStarknetSpec) Class(ctx context.Context, blockID rpc.BlockID, classHash *felt.Felt) (rpc.ClassOutput, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Class", ctx, blockID, classHash)
	ret0, _ := ret[0].(rpc.ClassOutput)
	ret1, _ := ret[1].(error)
...
// Class indicates an expected call of Class.
func (mr *MockStarknetSpecMockRecorder) Class(ctx, blockID, classHash any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Class", reflect.TypeOf((*MockStarknetSpec)(nil).Class), ctx, blockID, classHash)
}

// ClassAt mocks base method.
func (m *MockStarknetSpec) ClassAt(ctx context.Context, blockID rpc.BlockID, contractAddress *felt.Felt) (rpc.ClassOutput, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ClassAt", ctx, blockID, contractAddress)
	ret0, _ := ret[0].(rpc.ClassOutput)
	ret1, _ := ret[1].(error)
...
// ClassAt indicates an expected call of ClassAt.
func (mr *MockStarknetSpecMockRecorder) ClassAt(ctx, blockID, contractAddress any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ClassAt", reflect.TypeOf((*MockStarknetSpec)(nil).ClassAt), ctx, blockID, contractAddress)
}

// ClassHashAt mocks base method.
func (m *MockStarknetSpec) ClassHashAt(ctx context.Context, blockID rpc.BlockID, contractAddress *felt.Felt) (*felt.Felt, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ClassHashAt", ctx, blockID, contractAddress)
	ret0, _ := ret[0].(*felt.Felt)
	ret1, _ := ret[1].(error)
...
// ClassHashAt indicates an expected call of ClassHashAt.
func (mr *MockStarknetSpecMockRecorder) ClassHashAt(ctx, blockID, contractAddress any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ClassHashAt", reflect.TypeOf((*MockStarknetSpec)(nil).ClassHashAt), ctx, blockID, contractAddress)
}

// CompiledCasm mocks base method.
func (m *MockStarknetSpec) CompiledCasm(ctx context.Context, classHash *felt.Felt) (*contracts.CasmClass, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CompiledCasm", ctx, classHash)
	ret0, _ := ret[0].(*contracts.CasmClass)
	ret1, _ := ret[1].(error)
...
// CompiledCasm indicates an expected call of CompiledCasm.
func (mr *MockStarknetSpecMockRecorder) CompiledCasm(ctx, classHash any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CompiledCasm", reflect.TypeOf((*MockStarknetSpec)(nil).CompiledCasm), ctx, classHash)
}

// EstimateFee mocks base method.
func (m *MockStarknetSpec) EstimateFee(ctx context.Context, requests []rpc.BroadcastTxn, simulationFlags []rpc.SimulationFlag, blockID rpc.BlockID) ([]rpc.FeeEstimation, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "EstimateFee", ctx, requests, simulationFlags, blockID)
	ret0, _ := ret[0].([]rpc.FeeEstimation)
	ret1, _ := ret[1].(error)
...
// EstimateFee indicates an expected call of EstimateFee.
func (mr *MockStarknetSpecMockRecorder) EstimateFee(ctx, requests, simulationFlags, blockID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "EstimateFee", reflect.TypeOf((*MockStarknetSpec)(nil).EstimateFee), ctx, requests, simulationFlags, blockID)
}

// EstimateMessageFee mocks base method.
func (m *MockStarknetSpec) EstimateMessageFee(ctx context.Context, msg rpc.MsgFromL1, blockID rpc.BlockID) (rpc.MessageFeeEstimation, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "EstimateMessageFee", ctx, msg, blockID)
	ret0, _ := ret[0].(rpc.MessageFeeEstimation)
	ret1, _ := ret[1].(error)
...
// EstimateMessageFee indicates an expected call of EstimateMessageFee.
func (mr *MockStarknetSpecMockRecorder) EstimateMessageFee(ctx, msg, blockID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "EstimateMessageFee", reflect.TypeOf((*MockStarknetSpec)(nil).EstimateMessageFee), ctx, msg, blockID)
}

// Events mocks base method.
func (m *MockStarknetSpec) Events(ctx context.Context, input rpc.EventsInput) (*rpc.EventChunk, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Events", ctx, input)
	ret0, _ := ret[0].(*rpc.EventChunk)
	ret1, _ := ret[1].(error)
...
// Events indicates an expected call of Events.
func (mr *MockStarknetSpecMockRecorder) Events(ctx, input any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Events", reflect.TypeOf((*MockStarknetSpec)(nil).Events), ctx, input)
}

// MessagesStatus mocks base method.
func (m *MockStarknetSpec) MessagesStatus(ctx context.Context, transactionHash rpc.NumAsHex) ([]rpc.MessageStatus, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "MessagesStatus", ctx, transactionHash)
	ret0, _ := ret[0].([]rpc.MessageStatus)
	ret1, _ := ret[1].(error)
...
// MessagesStatus indicates an expected call of MessagesStatus.
func (mr *MockStarknetSpecMockRecorder) MessagesStatus(ctx, transactionHash any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "MessagesStatus", reflect.TypeOf((*MockStarknetSpec)(nil).MessagesStatus), ctx, transactionHash)
}

// Nonce mocks base method.
func (m *MockStarknetSpec) Nonce(ctx context.Context, blockID rpc.BlockID, contractAddress *felt.Felt) (*felt.Felt, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Nonce", ctx, blockID, contractAddress)
	ret0, _ := ret[0].(*felt.Felt)
	ret1, _ := ret[1].(error)
...
// Nonce indicates an expected call of Nonce.
func (mr *MockStarknetSpecMockRecorder) Nonce(ctx, blockID, contractAddress any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Nonce", reflect.TypeOf((*MockStarknetSpec)(nil).Nonce), ctx, blockID, contractAddress)
}

// SimulateTransactions mocks base method.
func (m *MockStarknetSpec) SimulateTransactions(ctx context.Context, blockID rpc.BlockID, txns []rpc.BroadcastTxn, simulationFlags []rpc.SimulationFlag) ([]rpc.SimulatedTransaction, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SimulateTransactions", ctx, blockID, txns, simulationFlags)
	ret0, _ := ret[0].([]rpc.SimulatedTransaction)
	ret1, _ := ret[1].(error)
...
// SimulateTransactions indicates an expected call of SimulateTransactions.
func (mr *MockStarknetSpecMockRecorder) SimulateTransactions(ctx, blockID, txns, simulationFlags any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SimulateTransactions", reflect.TypeOf((*MockStarknetSpec)(nil).SimulateTransactions), ctx, blockID, txns, simulationFlags)
}

// SpecVersion mocks base method.
func (m *MockStarknetSpec) SpecVersion(ctx context.Context) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SpecVersion", ctx)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
...
// SpecVersion indicates an expected call of SpecVersion.
func (mr *MockStarknetSpecMockRecorder) SpecVersion(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SpecVersion", reflect.TypeOf((*MockStarknetSpec)(nil).SpecVersion), ctx)
}

// StateUpdate mocks base method.
func (m *MockStarknetSpec) StateUpdate(ctx context.Context, blockID rpc.BlockID) (*rpc.StateUpdateOutput, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "StateUpdate", ctx, blockID)
	ret0, _ := ret[0].(*rpc.StateUpdateOutput)
	ret1, _ := ret[1].(error)
...
// StateUpdate indicates an expected call of StateUpdate.
func (mr *MockStarknetSpecMockRecorder) StateUpdate(ctx, blockID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "StateUpdate", reflect.TypeOf((*MockStarknetSpec)(nil).StateUpdate), ctx, blockID)
}

// StorageAt mocks base method.
func (m *MockStarknetSpec) StorageAt(ctx context.Context, contractAddress *felt.Felt, key string, blockID rpc.BlockID) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "StorageAt", ctx, contractAddress, key, blockID)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
...
// StorageAt indicates an expected call of StorageAt.
func (mr *MockStarknetSpecMockRecorder) StorageAt(ctx, contractAddress, key, blockID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "StorageAt", reflect.TypeOf((*MockStarknetSpec)(nil).StorageAt), ctx, contractAddress, key, blockID)
}

// StorageProof mocks base method.
func (m *MockStarknetSpec) StorageProof(ctx context.Context, storageProofInput rpc.StorageProofInput) (*rpc.StorageProofResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "StorageProof", ctx, storageProofInput)
	ret0, _ := ret[0].(*rpc.StorageProofResult)
	ret1, _ := ret[1].(error)
...
// StorageProof indicates an expected call of StorageProof.
func (mr *MockStarknetSpecMockRecorder) StorageProof(ctx, storageProofInput any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "StorageProof", reflect.TypeOf((*MockStarknetSpec)(nil).StorageProof), ctx, storageProofInput)
}

// Syncing mocks base method.
func (m *MockStarknetSpec) Syncing(ctx context.Context) (rpc.SyncStatus, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Syncing", ctx)
	ret0, _ := ret[0].(rpc.SyncStatus)
	ret1, _ := ret[1].(error)
...
// Syncing indicates an expected call of Syncing.
func (mr *MockStarknetSpecMockRecorder) Syncing(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Syncing", reflect.TypeOf((*MockStarknetSpec)(nil).Syncing), ctx)
}

// TraceBlockTransactions mocks base method.
func (m *MockStarknetSpec) TraceBlockTransactions(ctx context.Context, blockID rpc.BlockID) ([]rpc.Trace, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TraceBlockTransactions", ctx, blockID)
	ret0, _ := ret[0].([]rpc.Trace)
	ret1, _ := ret[1].(error)
...
// TraceBlockTransactions indicates an expected call of TraceBlockTransactions.
func (mr *MockStarknetSpecMockRecorder) TraceBlockTransactions(ctx, blockID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "TraceBlockTransactions", reflect.TypeOf((*MockStarknetSpec)(nil).TraceBlockTransactions), ctx, blockID)
}

// TraceTransaction mocks base method.
func (m *MockStarknetSpec) TraceTransaction(ctx context.Context, transactionHash *felt.Felt) (rpc.TxnTrace, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TraceTransaction", ctx, transactionHash)
	ret0, _ := ret[0].(rpc.TxnTrace)
	ret1, _ := ret[1].(error)
...
// TraceTransaction indicates an expected call of TraceTransaction.
func (mr *MockStarknetSpecMockRecorder) TraceTransaction(ctx, transactionHash any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "TraceTransaction", reflect.TypeOf((*MockStarknetSpec)(nil).TraceTransaction), ctx, transactionHash)
}

// TransactionByBlockIDAndIndex mocks base method.
func (m *MockStarknetSpec) TransactionByBlockIDAndIndex(ctx context.Context, blockID rpc.BlockID, index uint64) (*rpc.BlockTransaction, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TransactionByBlockIDAndIndex", ctx, blockID, index)
	ret0, _ := ret[0].(*rpc.BlockTransaction)
	ret1, _ := ret[1].(error)
...
// TransactionByBlockIDAndIndex indicates an expected call of TransactionByBlockIDAndIndex.
func (mr *MockStarknetSpecMockRecorder) TransactionByBlockIDAndIndex(ctx, blockID, index any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "TransactionByBlockIDAndIndex", reflect.TypeOf((*MockStarknetSpec)(nil).TransactionByBlockIDAndIndex), ctx, blockID, index)
}

// TransactionByHash mocks base method.
func (m *MockStarknetSpec) TransactionByHash(ctx context.Context, hash *felt.Felt) (*rpc.BlockTransaction, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TransactionByHash", ctx, hash)
	ret0, _ := ret[0].(*rpc.BlockTransaction)
	ret1, _ := ret[1].(error)
...
// TransactionByHash indicates an expected call of TransactionByHash.
func (mr *MockStarknetSpecMockRecorder) TransactionByHash(ctx, hash any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "TransactionByHash", reflect.TypeOf((*MockStarknetSpec)(nil).TransactionByHash), ctx, hash)
}

// TransactionReceipt mocks base method.
func (m *MockStarknetSpec) TransactionReceipt(ctx context.Context, transactionHash *felt.Felt) (*rpc.TransactionReceiptWithBlockInfo, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TransactionReceipt", ctx, transactionHash)
	ret0, _ := ret[0].(*rpc.TransactionReceiptWithBlockInfo)
	ret1, _ := ret[1].(error)
...
// TransactionReceipt indicates an expected call of TransactionReceipt.
func (mr *MockStarknetSpecMockRecorder) TransactionReceipt(ctx, transactionHash any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "TransactionReceipt", reflect.TypeOf((*MockStarknetSpec)(nil).TransactionReceipt), ctx, transactionHash)
}

// TransactionStatus mocks base method.
func (m *MockStarknetSpec) TransactionStatus(ctx context.Context, transactionHash *felt.Felt) (*rpc.TxnStatusResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TransactionStatus", ctx, transactionHash)
	ret0, _ := ret[0].(*rpc.TxnStatusResult)
	ret1, _ := ret[1].(error)
...
// TransactionStatus indicates an expected call of TransactionStatus.
func (mr *MockStarknetSpecMockRecorder) TransactionStatus(ctx, transactionHash any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "TransactionStatus", reflect.TypeOf((*MockStarknetSpec)(nil).TransactionStatus), ctx, transactionHash)
}

// MockRPCUtils is a mock of RPCUtils interface.
type MockRPCUtils struct {
	ctrl     *gomock.Controller
	recorder *MockRPCUtilsMockRecorder
	isgomock struct{}
}

// MockRPCUtilsMockRecorder is the mock recorder for MockRPCUtils.
type MockRPCUtilsMockRecorder struct {
	mock *MockRPCUtils
}

// NewMockRPCUtils creates a new mock instance.
func NewMockRPCUtils(ctrl *gomock.Controller) *MockRPCUtils {
	mock := &MockRPCUtils{ctrl: ctrl}
	mock.recorder = &MockRPCUtilsMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockRPCUtils) EXPECT() *MockRPCUtilsMockRecorder {
	return m.recorder
}

// EstimateTip mocks base method.
func (m *MockRPCUtils) EstimateTip(ctx context.Context) (rpc.U64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "EstimateTip", ctx)
	ret0, _ := ret[0].(rpc.U64)
	ret1, _ := ret[1].(error)
...
// EstimateTip indicates an expected call of EstimateTip.
func (mr *MockRPCUtilsMockRecorder) EstimateTip(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "EstimateTip", reflect.TypeOf((*MockRPCUtils)(nil).EstimateTip), ctx)
}

// IsCompatible mocks base method.
func (m *MockRPCUtils) IsCompatible(ctx context.Context) (bool, string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "IsCompatible", ctx)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(string)
...
// IsCompatible indicates an expected call of IsCompatible.
func (mr *MockRPCUtilsMockRecorder) IsCompatible(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IsCompatible", reflect.TypeOf((*MockRPCUtils)(nil).IsCompatible), ctx)
}
