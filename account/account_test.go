...
func TestBuildAndSendDeclareTxn(t *testing.T) {
	...
	resp, err := acc.BuildAndSendDeclareTxn(context.Background(), &casmClass, &class, 1.5, false, rpc.U64("0x0"))
	if err != nil {
...
func TestBuildAndSendMethodsWithQueryBit(t *testing.T) {
	...
	t.Run("TestBuildAndSendDeclareTxn", func(t *testing.T) {
		...
		// Build and send declare txn
		_, err := acnt.BuildAndSendDeclareTxn(context.Background(), &casmClass, &class, 1.5, true, rpc.U64("0x0"))
		require.Error(t, err)
