...
func check_policy{
...
}(call_array_len: felt, call_array: AccountCallArray*, root: felt, proof_len: felt, proof: felt*):
    alloc_locals
    ...
    check_policy(
        call_array_len - 1, call_array + AccountCallArray.SIZE, root, proof_len, proof + proof_len
    )
    return ()
end
