...
func __validate__{
    ...
    validate_with_plugin(plugin_id, call_array_len, call_array, calldata_len, calldata);
    return ();
}
...
func __execute__{
    ...
    let (response_len, response) = execute(call_array_len, call_array, calldata_len, calldata);
...
@external
func addPlugin{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    plugin: felt, plugin_calldata_len: felt, plugin_calldata: felt*
) {
    assert_only_self();
